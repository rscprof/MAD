...
// searchCitizens searches for citizens whose ages are within a given range.
// The function expects a GET request to the /search endpoint with minAge and maxAge query parameters.
// The function returns a JSON array of matching citizens.
// swagger:route GET /search citizens searchCitizens
//
// Search for citizens by age range.
//
//	Produces:
//	- application/json
//
