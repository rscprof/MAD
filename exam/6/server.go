...
// searchAnimeByTitle handles search requests based on a partial title match
func searchAnimeByTitle(w http.ResponseWriter, r *http.Request) {
	// Parse the title query parameter
...
func main() {
	http.HandleFunc("/search", searchAnimeByTitle)
