...
Разработайте функцию для вашего варианта задания, а также Unit-тесты для проверки её работы во всех случаях. Для написания Unit-тестов используйте библиотеку \texttt{kotlin.test}. Напишите минимум 3–5 тестов, покрывающих разные типы входных данных, включая \texttt{null} и неожиданные типы (при этом должно быть полное покрытие).
